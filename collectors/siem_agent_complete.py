...
# -*- coding: utf-8 -*-
"""
JFS ICT Services - SIEM Agent (Complete)
Single EXE with GUI + Service Installation
"""
...
class JFSSIEMAgent:
    ...
    def setup_ui(self):
        ...
        subtitle_label = tk.Label(logo_frame, text="Real-Time Security Event Collection with Service Installation", 
                                 font=("Segoe UI", 10), 
...
dist\\SIEM_Agent_HTTP.exe --server {self.server_ip.get()} --port {self.server_port.get()} --name {self.pc_name.get()}
"""
